...
// fournisseur list 
import FournisseursList from "../pages/Fournisseurs/Fournisseurs-list";
import FournisseursCreate from "../pages/Fournisseurs/fournisseurs-create";
import FournisseursDetail from "../pages/Fournisseurs/fournisseurs-detail";
...
import UsersCreate from '../pages/users/users-create'; // adapte le chemin
import UsersEdit from '../pages/users/users-edit'; // adapte le chemin
...
{ path: "/fournisseurs/create", component: <FournisseursCreate /> },
{ path: "/fournisseurs/:id", component: <FournisseursDetail /> },
